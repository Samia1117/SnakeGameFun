...
const BOARD_SIZE = 15;
const PROBABILITY_OF_DIRECTION_REVERSAL = 0.0;
...
const Board = () => {
    ...
    const handleFoodConsumption = newSnakeCells =>{
        ...
        const nextFoodShouldReverseDirection = Math.random() < PROBABILITY_OF_DIRECTION_REVERSAL;
                ...
                {board.map((row, rowIdx)=>(
                    <div key={rowIdx} className="row"> {
                        row.map((cellValue, cellIdx) => {
                            const className = getCellClassName(cellValue, foodCell, 
                                foodShouldReverseDirection, snakeCells);
